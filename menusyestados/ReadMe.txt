========================================================================
    APLICACIÓN: menusyestados Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación menusyestados.  

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación menusyestados.

menusyestados.vcxproj
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado menusyestados.pch y un archivo de tipos precompilados llamado StdAfx.obj.
